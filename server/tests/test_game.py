...
class TestGame:
    ...
    @pytest.mark.xfail(
        reason="Game logic not implemented yet", raises=NotImplementedError
    )
    ...
    def test_sun_rise(self):
        ...
        game = Game(NORMAL_CONFIG_6_PLAYER)
        # We need to start the game first to get to EVENING,
        # but start() raises NotImplementedError.
        # So we manually set the state for this test,
        # assuming start() worked or we are in a valid state.
